...
export function LocalFileUpload({ onFilesLoaded, loading = false }: LocalFileUploadProps) {
  ...
  return (
    <div
      ...
      onDrop={handleDrop}
      className={`border-2 border-dashed rounded-lg p-2 sm:p-3 transition-colors ${
        isLoading
      ...
      <div className="flex items-center justify-center gap-2">
        {isLoading ? (
          <>
            ...
            <span className="text-xs sm:text-sm text-foreground/70 truncate">Processing files...</span>
          </>
        ) : (
          <>
            <svg
